    ...
    <div class="contentfeedback">
      <form>
        <div class="form-group">
          ...
          <input class="form-control form-control" type="email" id="email" placeholder=" ایمیل خود را وارد کنید ">
          <small class="form-text text-muted-lg"> sampel@email.com </small>
          <br><br>
          <label for="name"> حساب کاربری : </label>
          <input class="form-control form-control" type="name" id="email" placeholder=" یک حساب کاربری منحصر به فرد انتخاب کنید">
          <br><br>
          <label for="password"> رمز عبور : </label>
          <input class="form-control form-control" type="password" id="password" placeholder="پسورد شامل حروف و اعداد باشد">
          <br><br>
        </div>
        <div style="align-items: center;">
          <div class="btn btn-group">
            <button class="btn btnfeed ">ثبت نام</button>
            <button class="btn btnfeed ">ورود</button>
          </div>
        </div>
    </div>
    </form>
